            ...
            <>
              ...
              >
                <div className="flex items-center justify-between gap-x-4">
                  ...
                  {tier.mostPopular && (
                    <p className="rounded-full bg-cyan-900/10 px-2.5 py-1 text-xs font-semibold leading-5 text-cyan-900">
                      Plus populaire
                    </p>
                  )}
                </div>
                ...
                <a
                  ...
                  className={
                    "mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 text-slate-700 ring-1 ring-inset ring-slate-400 hover:ring-slate-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-900"
                  }
                >
                ...
                >
                  {tier.features.map((feature) => (
                    <li key={feature} className="flex gap-x-3">
                      <CheckIcon
                        className="h-6 w-5 flex-none text-cyan-900"
                        aria-hidden="true"
                      />
                      {feature}
                    </li>
