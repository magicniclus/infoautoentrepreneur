        ...
        <section className="py-24">
          <div className="mx-auto max-w-6xl px-6 lg:px-8 text-slate-700 flex flex-col items-center">
            ...
            <div className="w-full mt-16 text-sm">
              ...
              <p className="mt-3">
                1.1. Bienvenue sur info-autoentrepreneur.fr, le portail dédié à
                l&apos;accompagnement des futurs auto-entrepreneurs dans leur
                démarche d&apos;inscription et dans la gestion de leurs
                activités professionnelles indépendantes. Ce site, désigné
                ci-après par « le Site », propose une gamme de services visant à
                faciliter l&apos;inscription au statut d&apos;auto-entrepreneur
                ainsi que l&apos;accès à des ressources et outils spécifiques
                (ci-après, les « Services d&apos;Inscription »). Ce service
                s&apos;adresse exclusivement aux individus agissant en vue de
                leur activité professionnelle, qu&apos;elle soit commerciale,
                industrielle, artisanale, ou libérale, désignés ci-après par «
                le Client » ou « Vous ».
              </p>
              <p className="mt-3">
                1.2. Toute interaction et contrat établis via le Site le sont
                avec Nicolas Catera, entreprise de droit français, située au 22
                rue de Libourne, 33100 Bordeaux, France (ci-après désignée «
                l&apos;Entreprise » ou « Nous »).
              </p>
              <p className="mt-3">
                1.3. L&apos;Entreprise est indépendante de toute administration
                publique ou privée gérant les formalités d&apos;entreprise
              ...
              <p className="mt-3">
                ...
                Nicolas Catera, propriétaire de l&apos;entreprise éponyme.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                ...
                info-autoentrepreneur.fr s’effectue exclusivement en ligne et en
              ...
              <p className="mt-3">
                L’inscription donne accès à une variété de services dédiés à
                l’auto-entrepreneur, incluant la vérification et la transmission
                du dossier d’inscription, l’utilisation d’outils de gestion de
                devis et factures, ainsi qu’un support client dédié pour toute
                question relative à la gestion du statut d’auto-entrepreneur.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                ...
                active, lors de son inscription sur info-autoentrepreneur.fr. La
                communication principale entre info-autoentrepreneur.fr et le
                ...
                délai à info-autoentrepreneur.fr par le Client.
              </p>
              <p className="mt-3">
                En cas de demande spécifique de info-autoentrepreneur.fr, le
                Client s&aposengage à répondre et à fournir les informations ou
              ...
              <p className="mt-3">
                6.1. Info-autoentrepreneur.fr n&apos;endosse aucune
              ...
              <p className="mt-3">
                ...
                et réglementations applicables. Info-autoentrepreneur.fr ne
              ...
              <p className="mt-3">
                6.3. La responsabilité totale de info-autoentrepreneur.fr
              ...
              <p className="mt-3">
                6.4. Info-autoentrepreneur.fr ne peut être tenu pour responsable
              ...
              <p className="mt-3">
                Info-autoentrepreneur.fr s&apos;efforce d&apos;assurer
              ...
              <p className="mt-3">
                ...
                l&apos;activité du Site et des services,
                info-autoentrepreneur.fr informera le Client par email, lui
                permettant de télécharger ses données stockées en ligne dans un
                délai de 30 jours. Passé ce délai, sans action de la part du
                Client pour récupérer ses données, il perd tout droit
                d&apos;accès et ne pourra prétendre à aucun dédommagement.
              </p>
              <p className="mt-3">
              ...
              <p className="mt-3">
                8.1. Info-autoentrepreneur.fr détient tous les droits de
              ...
              <p className="mt-3">
                8.2. L’accès au site info-autoentrepreneur.fr ne confère au
                Client aucun droit sur les éléments de propriété intellectuelle
                qui restent l’exclusivité de l&apos;entreprise Nicolas Catera.
              </p>
              <p className="mt-3">
                ...
                préalable écrit de Nicolas Catera. Tout manquement à cette règle
              ...
              <p className="mt-3">
                8.6. Info-autoentrepreneur.fr peut contenir des liens vers des
                sites tiers non gérés par Nicolas Catera. Ces liens sont fournis
                pour la commodité du Client qui les utilise à ses propres
                risques.
              </p>
              <p className="mt-3">
                8.7. Nicolas Catera n&apos;exerce aucun contrôle et ne participe
                pas à l&apos;élaboration des contenus ou des conditions
                d&apos;utilisation des sites tiers.
              </p>
              <p className="mt-3">
                8.8 à 8.10. Le Client reconnaît que Nicolas Catera ne peut être
                tenu responsable du contenu ou des pratiques des sites tiers, ni
                endosser ou garantir leurs produits ou services.
              </p>
              <p className="mt-3">
                8.11. Tout lien vers info-autoentrepreneur.fr doit recevoir
                l&apos;approbation écrite de Nicolas Catera, respecter les
                conditions définies et ne peut en aucun cas nuire à l&apos;image
                de l&apos;entreprise.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                9.1. Nicolas Catera traite les données personnelles du Client
                dans le respect de la législation en vigueur, avec
                l&apos;objectif principal de fournir et optimiser les services
                proposés sur info-autoentrepreneur.fr.
              </p>
              <p className="mt-3">
                9.2. Le Client dispose à tout moment d&apos;un droit
                d&apos;accès, de modification, d&apos;opposition, et de
                suppression de ses données personnelles en contactant Nicolas
                Catera à l&apos;adresse indiquée, en respectant les procédures
                légales.
              </p>
              <h3 className="text-lg font-semibold mt-7">10. Sous-traitance</h3>
              <p className="mt-3">
                Le Client accepte que Nicolas Catera puisse engager des
                sous-traitants pour certaines tâches liées à la fourniture des
                services proposés sur info-autoentrepreneur.fr, et autorise la
              ...
              <p className="mt-3">
                ...
                fonctionnement de info-autoentrepreneur.fr, le Client est invité
                à contacter Nicolas Catera via l&apos;email ou l&apos;adresse
                postale fournie, garantissant un support attentif et adapté à
                ses besoins.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                L&apos;échange de correspondances entre info-autoentrepreneur.fr
              ...
              <p className="mt-3">
                ...
                communiquées par email par info-autoentrepreneur.fr sont
                considérées comme valides et font foi entre les parties, tout
                comme les informations publiées directement sur le site.
              </p>
              <p className="mt-3">
                Les données enregistrées par info-autoentrepreneur.fr, y compris
              ...
              <p className="mt-3">
                ...
                entre Nicolas Catera et le Client concernant l&apos;utilisation
                du site info-autoentrepreneur.fr. Elles remplacent et annulent
                tout engagement oral ou écrit préalable relatif à l&apos;objet
                de ces conditions.
              </p>
              <p className="mt-3">
                Le non-exercice par Nicolas Catera de ses droits, en vertu des
                présentes Conditions Générales, ne constitue pas une
